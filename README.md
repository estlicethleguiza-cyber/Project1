...
int main()
{
	...
	GLfloat vertices[] =
	{
		...
		- 0.5f / 2, 0.5f * float(sqrt(3)) / 6, 0.0f, // Vertice interno izquierdo
		0.5f / 2, 0.5f * float(sqrt(3)) / 6, 0.0f,  // Vertice interno derecho
		0.0f, -0.5f * float(sqrt(3)) / 3, 0.0f, // Vertice interno inferior
	

	};
	//----------------------- Crea los indices -----------------------

	// indica el orden en el que se van a unir los vertices
	GLuint indices[] =
	{
		0, 3, 5, // Triangulo inferior izquierdo
		3, 2, 4, // Triangulo superior
		5, 4, 1  // Triangulo inferior derecho
	};
